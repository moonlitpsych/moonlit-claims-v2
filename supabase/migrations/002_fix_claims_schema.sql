-- Fix Claims Schema Migration
-- Drops and recreates all claims-related tables with correct schema
...
-- Indexes for performance (using IF NOT EXISTS to avoid errors)
